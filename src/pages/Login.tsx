        ...
        <CardContent>
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(e) => setRegisterData({...registerData, cognome: e.target.value})}
                      placeholder="Rossi"
                      required
                    />
                  </div>
          ...
          <div className="mt-6 p-4 bg-primary/5 rounded-lg">
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="font-medium text-sm">Account Demo</span>
            </div>
            <p className="text-xs text-muted-foreground mb-2">
              Prova subito FatturaPsicologo:
            </p>
            <p className="text-xs font-mono bg-muted p-2 rounded">
              Email: demo@psicologo.it<br />
              Password: demo123
            </p>
          </div>
        </CardContent>
